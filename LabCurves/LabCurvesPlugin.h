...
#ifndef LABCURVES_PLUGIN_H
#define LABCURVES_PLUGIN_H
...
#define PLUGIN_NAME		"LabCurves"
#define PLUGIN_GROUP	"LabCurves"


class LabCurvesPlugin : public QObject, public B5Plugin  // QObject class needed because slots are used
{
