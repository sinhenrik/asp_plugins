...
#ifndef LABTOOLS_PLUGIN_H
#define LABTOOLS_PLUGIN_H
...
#define PLUGIN_NAME		"LabTools"
#define PLUGIN_GROUP	"LabTools"


class LabToolsPlugin : public QObject, public B5Plugin  // QObject class needed because slots are used
{
...
private:
    ...
    QDoubleSpinBox* lightnessEdit;
    QDoubleSpinBox* saturationEdit;
};
